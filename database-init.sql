...
create table questions_comments (id MEDIUMINT NOT NULL AUTO_INCREMENT, comment varchar(255) NOT NULL, question_id MEDIUMINT NOT NULL, PRIMARY KEY (id), FOREIGN KEY (question_id) REFERENCES questions(id));
create table answers_comments (id MEDIUMINT NOT NULL AUTO_INCREMENT, comment varchar(255) NOT NULL, answer_id MEDIUMINT NOT NULL, PRIMARY KEY (id), FOREIGN KEY (answer_id) REFERENCES answers(id));